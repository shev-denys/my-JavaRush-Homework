package com.javalearn.test.level18.lesson08.task03;
...
2.2 дописать следующий текст [javalearn © 2012-2013 All rights reserved.], используйте метод getBytes()
...
public class AmigoOutputStream extends FileOutputStream{
    ...
    public void close() throws IOException
    {
        ...
        original.write("javalearn © 2012-2013 All rights reserved.".getBytes());
        original.close();
    }
}
