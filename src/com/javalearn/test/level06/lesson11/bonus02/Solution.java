package com.javalearn.test.level06.lesson11.bonus02;
...
public class Solution
{
    public static void main(String[] args) throws IOException
    {
        ...
        Cat catSun = new Cat(catSunName, catFather, catMother);

        String catDoughterName = reader.readLine();
        Cat catDaughter = new Cat(catDoughterName, catFather, catMother);
