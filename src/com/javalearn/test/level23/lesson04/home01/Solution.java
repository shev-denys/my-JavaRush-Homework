package com.javalearn.test.level23.lesson04.home01;
...
public class Solution {
    ...
    class TaskDataProvider extends Task implements DbDataProvider
    {
        @Override
    ...
    class NameDataProvider extends DbMock implements DbDataProvider
    {
        @Override
        public void refreshAllData(Map criteria)
        {
