package com.javalearn.test.level20.lesson02.task05;
...
public class Solution
{
    ...
    public static class Object
    {
        ...
        public void save(OutputStream outputStream) throws Exception
        {
            ...
            printWriter.println(this.string1 != null ? this.string1.number  : "null");
            printWriter.println(this.string2 != null ? this.string2.number  : "null");
            printWriter.close();
        }
