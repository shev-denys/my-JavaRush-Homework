package com.javalearn.test.level20.lesson02.task02;
...
/* Читаем и пишем в файл: javalearn
Реализуйте логику записи в файл и чтения из файла для класса javalearn
В файле your_file_name.tmp может быть несколько объектов javalearn
...
public class Solution
{
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            javalearn.users.add(user);
            javalearn.users.add(new User());
            //initialize users field for the javalearn object here - инициализируйте поле users для объекта javalearn тут
            javalearn.save(outputStream);
            outputStream.flush();

            javalearn loadedObject = new javalearn();
            loadedObject.load(inputStream);
            //check here that javalearn object equals to loadedObject object - проверьте тут, что javalearn и loadedObject равны
