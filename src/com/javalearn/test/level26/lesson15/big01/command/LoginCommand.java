...
{
    private ResourceBundle validCreditCards = ResourceBundle.getBundle("com.javalearn.test.level26.lesson15.big01.resources." + "verifiedCards");
    private ResourceBundle res = ResourceBundle.getBundle("com.javalearn.test.level26.lesson15.big01.resources." + "login_en");
